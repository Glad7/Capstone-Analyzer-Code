...
def main():
    ...
    if signature.sig_four(file):
        print('WARNING, SIGNATURE 4 TRIGGERED')
        flag = 1

    if signature.sig_five():
        print('WARNING, SIGNATURE 5 TRIGGERED')
        flag = 1

    if signature.sig_six():
        print('WARNING, SIGNATURE 6 TRIGGERED')
        flag = 1

    if  signature.sig_seven():
        print('WARNING, SIGNATURE 7 TRIGGERED')
        flag = 1

    if signature.sig_eight():
        print('WARNING, SIGNATURE 8 TRIGGERED')
        flag = 1

    if signature.sig_nine():
        print('WARNING, SIGNATURE 9 TRIGGERED')
        flag = 1
